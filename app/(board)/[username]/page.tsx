    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-8 sticky top-0 backdrop-blur:md p-4 z-10 bg-[#00000084]">
                ...
                <h1 className="font-bold text-lg">Ankan Biswas</h1>
            </div>
            {/* Information  */}
            <div>
                ...
                <div className="p-4 flex flex-col gap-2">
                    <h1 className="text-2xl font-bold">Ankan Biswas</h1>
                    <span className="text-textGray text-sm">@Ankandada</span>
                    ...
                    <div className="flex gap-4">
                        <div className=" flex items-center gap-2">
                            ...
                            <span className="text-textGray text-[15x]">Followers</span>
                        </div>
                        <div className=" flex items-center gap-2">
                            <span className="font-bold">100</span>
                            <span className="text-textGray text-[15x]">Followings</span>
                        </div>
                    </div>
                </div>
            </div>
